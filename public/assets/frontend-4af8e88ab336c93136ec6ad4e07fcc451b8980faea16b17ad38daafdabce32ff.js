...
(function($) {"use strict";
	...
	Filestyle.prototype = {
		...
		iconName : function(value) {
			if (value !== undefined) {
				this.$elementFilestyle.find('.icon').attr({
					'class' : '.icon ' + this.options.iconName
				});
			} else {
		...
		htmlIcon : function() {
			if (this.options.icon) {
				return '<span class="icon ' + this.options.iconName + '"></span> ';
			} else {
				return '';
			}
		},
...
$(document).on('ready', function(){
  ...
  $('.slider').css('padding-top', $('nav.fixed-top').outerHeight() + 110)
  $('.slider').css('padding-bottom', 110)
  $('.slider-page').css('padding-top', $('nav.fixed-top').outerHeight() + 55)
  ...
  $(window).scroll(function(){
    if($(this).scrollTop() >= $('nav.fixed-top').outerHeight()){
      $('nav.fixed-top').css('margin-top', 0);
      $('nav.fixed-top').addClass('fixed-nav');
    } else {
      $('nav.fixed-top').css('margin-top', $('.upper-header').outerHeight());
