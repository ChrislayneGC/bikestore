...
$('nav.fixed-top').css('margin-top', $('.upper-header').outerHeight());

$(document).on('ready', function(){

  $('.slider-page').css('padding-top', 55)
  $('.slider-page').css('padding-bottom', 55)
  ...
  $(window).scroll(function(){
    if($(this).scrollTop() > 0){
      ...
      $('div.upper-header').removeClass('section');
      $('div.upper-header').addClass('fixed-top');

    }else{
      $('div.upper-header').removeClass('fixed-top');
      $('div.upper-header').addClass('section');
    }

    if($(this).scrollTop() >= $('nav.fixed-top').outerHeight()){
      $('nav.fixed-top').css('margin-top', 31);
      $('nav.fixed-top').addClass('fixed-top');

    } else {
      $('nav.fixed-top').css('margin-top', $('.upper-header').outerHeight());
      $('nav.fixed-top').removeClass('fixed-nav');
  ...
  js.src = 'https://connect.facebook.net/pt_BR/sdk.js#xfbml=1&version=v3.0&appId=124788917730567&autoLogAppEvents=1';
